...
local function attach_typescript(bufnr)
  wk.add({
    ...
    { "<leader>cf",  function() require('vtsls').commands.fix_all() end,                   desc = "fix all" },
    { "<leader>ci",  function() require('vtsls').commands.add_missing_imports() end,       desc = "import all" },
    { "<leader>co",  function() require('vtsls').commands.organize_imports() end,          desc = "organize imports" },
    { "<leader>cs",  function() require('vtsls').commands.sort_imports() end,              desc = "sort imports" },
    { "<leader>cu",  function() require('vtsls').commands.remove_unused_imports() end,     desc = "remove unused" },
    { "<leader>cR",  function() require('vtsls').commands.rename_file() end,               desc = "rename file" },
    { "<leader>cF",  function() require('vtsls').commands.file_references() end,           desc = "file references" },
  })
end
